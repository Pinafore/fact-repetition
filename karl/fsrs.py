...
class FSRS:
    ...
    def repeat(self, card: FSRSCard, now: datetime) -> Dict[int, SchedulingInfo]:
    ...
    def init_ds(self, s: SchedulingFSRSCards) -> None:
    ...
    def next_ds(self, s: SchedulingFSRSCards, last_d: float, last_s: float, retrievability: float):
