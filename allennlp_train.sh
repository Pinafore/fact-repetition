...
conda activate fact
allennlp train --include-package fact -s checkpoints/karl-bert -f configs/generated/bert.jsonnet
# allennlp train --include-package fact -s checkpoints/karl-rnn -f configs/generated/rnn.jsonnet
