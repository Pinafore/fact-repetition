...
DEV_QUESTION_FILE = './qanta.dev.2018.04.18.json'
TEST_QUESTION_FILE = './qanta.test.2018.04.18.json'
...
for i in range(len(FILE_NAME)):
    print("Start processing: ", FILE_NAME[i])
    ...
    question_data_list = question_data_list + question_data
