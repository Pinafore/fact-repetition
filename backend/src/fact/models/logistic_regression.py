...
test_inst = QantaReader().read(QANTA_TRAIN) 
...
for tokens in tqdm(train_text_list):
    ...
    feature_vector = np.concatenate((question_features, user_features), axis=None)
...
clf1 = LogisticRegression(solver='lbfgs', max_iter=2000, random_state=123)
